...
$games = [
    ...
    ['id' => 6, 'name' => 'Candy Crush', 'category' => 'puzzle', 'icon' => '🍬', 'desc' => '사탕 매칭 퍼즐', 'status' => 'completed'],
    ...
    ['id' => 9, 'name' => 'Cut the Rope', 'category' => 'puzzle', 'icon' => '✂️', 'desc' => '밧줄 자르기 물리 퍼즐', 'status' => 'completed'],
