...
<head>
    ...
    <link rel="stylesheet" href="../../css/style.css">
        ...
        html, body { overflow: hidden; height: 100%; margin: 0; background: #faf8ef; }
        ...
        .tile { background: #c9b99a; border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 20px; cursor: pointer; transition: all 0.1s; }
...
<body>
    ...
    <main class="game-area">
        ...
        <div class="controls">
            ...
            <select id="level" onchange="initGame()" class="btn" style="flex:0.5;"><option value="easy">쉬움</option><option value="normal" selected>보통</option><option value="hard">어려움</option></select>
        </div>
