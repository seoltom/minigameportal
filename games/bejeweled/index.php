...
<head>
    ...
    <style>
        ...
        .gem.matched {
            animation: matchedPop 0.3s ease-out forwards;
        }
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; padding: 8px 10px; background: #fff; border-radius: 8px; margin-bottom: 10px;">
            <div style="display: flex; gap: 15px;">
                ...
                <div style="text-align: center;">
                    ...
                    <div style="font-size: 18px; font-weight: bold;" id="level">1</div>
                </div>
                <div style="text-align: center;">
                    <div style="font-size: 10px; color: #888;">TARGET</div>
                    <div style="font-size: 18px; font-weight: bold;" id="target">500</div>
                </div>
            </div>
